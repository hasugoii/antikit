...
➡️ **下一步:**
   1️⃣ 彻底测试: 输入 `/test` 检查逻辑
   2️⃣ 继续: 输入 `/plan` 做新功能
   3️⃣ 清理: 输入 `/refactor` 如果代码需要优化
   4️⃣ 部署: 输入 `/deploy` 如果准备上服务器"
```
